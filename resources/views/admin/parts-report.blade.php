...
<body>
    @if (session()->has("error"))
        <div class="msg danger" id="msg">
            <p>{{ session()->get("error") }}</p>
        </div>    
    @endif

    @if (session()->has("success"))
        <div class="msg success" id="msg">
    ...
    <div class="control">
        ...
        <a href="/admin/api/customer/{{ $customer->id }}/send-parts-report" class="email">Email this to customer</a>
    </div>
    <script>
